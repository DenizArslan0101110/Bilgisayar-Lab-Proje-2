...
public class CardForGraphics
{
    ...
    byte last_used, index_in_deck, hp;
    short x_pos, y_pos, display_x_pos, display_y_pos, width, height;
    double rotation;
    String path;
    BufferedImage image;

    CardForGraphics(short x_pos, short y_pos, short width, short height, double rotation, String path, boolean owners_ID, byte index_in_deck, byte hp, byte last_used, boolean in_battle_rn)
    {
        this.x_pos = x_pos;
        this.y_pos = y_pos;
